...
import com.wifi.activity.ConnActivity;
...
public class WiFiServerBroadcastReceiver extends BroadcastReceiver {
    ...
    private ConnActivity activity;

    public WiFiServerBroadcastReceiver(WifiP2pManager manager, Channel channel,ConnActivity activity) {
        super();
...
//        	}
        	...
        	activity.setServerWifiStatus("Wifi Connection Changed");
        	...
        	if(networkState.isConnected())
        	{
                ...
                activity.getWifiInfo(wifiInfo,device);
                
                activity.setServerWifiStatus("Wifi Info Changed" + wifiInfo.groupOwnerAddress);
