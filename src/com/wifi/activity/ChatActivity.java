    ...
    public Handler handler = new Handler() {    //�½������̬�ı����
    	...
    	public void handleMessage(Message msg) {
           if(msg.what == 1 && BitmapFactory.decodeFile(imgPath)!=null){
        	   //updateView("�յ�һ��ͼƬ��");
        	   updateImg(BitmapFactory.decodeFile(imgPath),R.layout.list_img_layout_income,"��׿�豸");
           }
           else {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        OnClickListener messageButtonListener = new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                //updateView(msgText);
                updateImg(BitmapFactory.decodeFile(fileToSend.getPath()),R.layout.list_img_layout,"��");
                }
                else{
        		...
        		if(targetDir.isFile())
        		{
        			if(targetDir.canRead())
        			{
        				...
        				Log.i(TAG, targetDir.getName() + " selected for file transfer");
							...
							.setTitle("��ʾ").setMessage("��ѡ��jpg��ʽ��ͼƬ")
